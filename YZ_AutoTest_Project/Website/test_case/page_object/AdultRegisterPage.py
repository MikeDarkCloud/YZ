...
class Auto_CJ_Register(Action,rewrxl):
    ...
    Education1_loc=(By.XPATH,'/html/body/span/span/span[1]/input')
    ...
    Grade_loc=(By.XPATH,'//*[@id="select2-pfsnLevel-container"]')
    Grade1_loc=(By.XPATH,'/html/body/span/span/span[1]/input')
    ...
    def type_cheng_register(self):
        ...
        sleep(3)
        self.find_element(*self.Add_Student_loc).send_keys(Keys.ENTER)
        sleep(3)
        ...
        sleep(2)
        self.find_element(*self.Education_loc).send_keys('高')
        ...
        sleep(4)
        u=self.find_element(*self.Grade_loc)
